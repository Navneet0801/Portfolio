...
export const metadata: Metadata = {
  title: "Portfolio: Navneet Kumar",
  description:
    "Navneet Kumar is a passionate developer with a diverse skill set spanning both front-end web development and system-level programming",
  keywords: "navneetkumar, navneetk0801, navneetkumar portfolio",
};
